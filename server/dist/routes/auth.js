...
router.post("/forgot-password", async (req, res) => {
    ...
    if (user) {
        ...
        await (0, email_1.sendEmail)(email, "Reset your MindMatters password", `<p>Click the link to reset your password:</p><p><a href="${link}">${link}</a></p><p>This link expires in 30 minutes.</p>`);
    }
    db.close();
